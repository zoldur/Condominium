...
COIN_TGZ='https://github.com/condominium/CondominiumCore/releases/download/untagged-d66adb337e7c4361d84f/linux.zip'
...
function download_node() {
  ...
  cp linux/$COIN_CLI $COIN_PATH >/dev/null 2>&1
  cp linux/$COIN_DAEMON $COIN_PATH >/dev/null 2>&1
